    ...
    public class EntityMapper : Profile
    {
		public EntityMapper()
		{
			...
			CreateMap<Core.Model.SalesOrder, ViewModel.SalesOrder>()
				...
				.ForMember(d => d.TraderID, opt => opt.MapFrom(src => src.Trader.Id))
				.ReverseMap();
			...
			CreateMap<ViewModel.SalesOrder, Core.Model.SalesOrder>()
				.ForMember(dest => dest.Buyer, opts => opts.MapFrom(source => new User {Id = source.Id}))
				.ForMember(dest => dest.Trader, opts => opts.MapFrom(source => new User {Id = source.Id}));
			CreateMap<Core.Model.SalesOrder, ViewModel.SalesOrder>()
