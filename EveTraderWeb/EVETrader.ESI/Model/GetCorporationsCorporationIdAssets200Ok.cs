...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCorporationsCorporationIdAssets200Ok :  IEquatable<GetCorporationsCorporationIdAssets200Ok>, IValidatableObject
    {
        ...
        public GetCorporationsCorporationIdAssets200Ok(bool? IsSingleton = default(bool?), long? ItemId = default(long?), LocationFlagEnum LocationFlag = default(LocationFlagEnum), long? LocationId = default(long?), LocationTypeEnum LocationType = default(LocationTypeEnum), int? Quantity = default(int?), int? TypeId = default(int?))
        {
